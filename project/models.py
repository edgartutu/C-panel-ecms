...
class Admin_Headquaters(db.Model, UserMixin):
    ...
    def __init__(self, admin_email,admin_Name, password,publicID,role):
        self.admin_email = admin_email
        self.admin_Name=admin_Name
        self.password = password
    ...
    def json(self):
        return {'admin_email':self.admin_email,'admin_name':self.admin_Name,'password':self.password,'publicid':self.publicID,'role':self.role}
...
class Complaints(db.Model, UserMixin):
    ...
    agent_name = db.Column(db.String(25))
    agent_email=db.Column(db.String(100))
    complainant_phone=db.Column(db.String(100))
    agent_idn0=db.Column(db.String(100))
    agent_staff=db.Column(db.String(100))
    district=db.Column(db.String(100))
    complainant_location = db.Column(db.String(500))
    ...
    def __init__(self,agent_name,agent_email,complainant_phone,agent_idn0,agent_staff,district,complainant_location,compalianant_name,
        ...
        self.complainant_location = complainant_location
    ...
    def json(self):
        return {'agent_name':self.agent_name,'files':self.files,
                ...
                'poling_station':self.complainant_location, 'complaints_refn0':self.complaints_refn0,'nature_complaint':self.nature_complaint,'complaint':self.complaint,'date':self.date,
                ...
                'headclassification':self.headclassification,'comments': self.comments,'agent_phone':self.complainant_phone,'agent_staff':self.agent_staff,'agent_email':self.agent_email
                }
