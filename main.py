...
from project.admin_headquaters.views import  UserActivity,Getdbtable,DB_registration,AdminPass,ComplainUpdates,filezresolved,files,Tabledistrict,Account,Accounts,AminStore,AllDeclinedComplaintsadmin,CodeDistrict,PieChartsdistrict,UpdateDeclinedComplaints,Unresolves, Monthlys,LoginHeadquaters,Register2,AllDistrictheadComplaints,PostzComplaint,AminPostComplaints,AdminGetComplaints,AllAdminGetComplaints,AdminPieChart,Alllevelones
...
api.add_resource(DB_registration, '/DB_registration')
api.add_resource(Getdbtable, '/Getdbtable')
api.add_resource(UserActivity, '/UserActivity')
